...
import { ChevronLeftOutlined, ExpandLess, ExpandMore, StarBorder } from '@mui/icons-material';
...
const sections = [

    {
        ...
        name: 'Bicicletas',
        subSections: ['Resumen', 'Añadir bicicletas', 'Eliminar bicicletas', 'Modificar estado']
    },
    {
        icon: <AutoStoriesOutlinedIcon />,
        name: 'Reservas',
        subSections: ['Resumen', 'Crear reserva', 'Modificar reserva', 'Eliminar reserva']
    },
    {
            ...
            <List>
                {sections.map((section, sectionIndex) =>
                    <Box key={section.name}>
                        <ListItem onClick={toogleList(sectionIndex)} disablePadding
                            sx={{ pr: 2 }}
                        >
                            <ListItemButton
                                sx={{ pr: 5 }}
                        ...
                        {section.subSections.map(subSection =>
                            <ListItem key={subSection} disablePadding>
                                <Collapse in={openList[sectionIndex]} timeout="auto" unmountOnExit>
